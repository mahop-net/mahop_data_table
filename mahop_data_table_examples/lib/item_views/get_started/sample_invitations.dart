...
class _SampleInvitationsState extends State<SampleInvitations> {
  ...
  void initState() {
    ...
    items = addresses.map((i) {
      ...
      return InvitationStatusItemViewModel(
          address: i, invitationsStatus: invitationsStatus);
    }).toList();
    ...
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
      ...
      columnWidth: 180,
      buildDisplay: (BuildContext context, InvitationStatusItemViewModel item,
              MhItemsViewDisplayInfo displayInfo) =>
          buildInvitationStatus(context, item, displayInfo),
      allowSorting: true,
    ...
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        ...
        header: "First name",
        columnWidth: 110,
        getDisplayValue: (item) => item.address.firstName,
        allowSorting: true));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "lastName",
        header: "Last name",
        columnWidth: 150,
        getDisplayValue: (item) => item.address.lastName,
        allowSorting: true));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "street",
        header: "Street",
        columnWidth: 150,
        getDisplayValue: (item) => item.address.street));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "state",
        header: "State",
        columnWidth: 50,
        getDisplayValue: (item) => item.address.state,
        allowSorting: true));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "zipCode",
        header: "Zip",
        columnWidth: 40,
        getDisplayValue: (item) => item.address.zipCode,
        allowSorting: true));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "city",
        header: "City",
        columnWidth: 120,
        getDisplayValue: (item) => item.address.city,
        allowSorting: true));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "telephoneNumber",
        header: "Phone",
        columnWidth: 150,
        getDisplayValue: (item) => item.address.telephoneNumber));
    columnDefs.add(MhItemsViewColumnDef<InvitationStatusItemViewModel>(
        id: "mobileTelephoneNumber",
        header: "Mobile phone",
        columnWidth: 150,
        getDisplayValue: (item) => item.address.mobileTelephoneNumber));
    ...
    settings.statusViewSettings =
        MhStatusViewSettings<InvitationStatusItemViewModel>(itemsDef: [
      MhStatusViewItemsDef<InvitationStatusItemViewModel>(
          text: "Invitations send",
          color: Colors.blue,
          showItem: (item) =>
  ...
  Widget build(BuildContext context) {
    ...
    var mhItemsView = MhItemsView<InvitationStatusItemViewModel>(
  ...
  Widget buildInvitationStatus(
      BuildContext context,
      InvitationStatusItemViewModel item,
      MhItemsViewDisplayInfo rowIsSelected) {
  ...
  Widget buildPopup(BuildContext context, InvitationStatusItemViewModel item,
      OverlayPortalController popupController) {
    return Container(
      decoration: BoxDecoration(
          border: Border.all(
              color: const Color.fromARGB(40, 125, 125, 125), width: 2),
        ...
        children: [
          ...
          MouseRegion(
            ...
            child: GestureDetector(
              ...
              child: buildInvitationStatusLabel(
                  InvitationStatus.invitationSend, false),
            ),
          ),
          MouseRegion(
            cursor: SystemMouseCursors.click,
            child: GestureDetector(
              ...
              child:
                  buildInvitationStatusLabel(InvitationStatus.accepted, false),
            ),
          ),
          MouseRegion(
            cursor: SystemMouseCursors.click,
            child: GestureDetector(
              ...
              child:
                  buildInvitationStatusLabel(InvitationStatus.declined, false),
            ),
          ),
          MouseRegion(
            cursor: SystemMouseCursors.click,
            child: GestureDetector(
              ...
              child: buildInvitationStatusLabel(
                  InvitationStatus.addressWrong, false),
            ),
          ),
        ],
      ),
