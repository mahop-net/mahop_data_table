...
class SampleSaveViewStateHelp {
  static Widget buildHelp() {
    return const SingleChildScrollView(
      child: Padding(
        padding: EdgeInsets.all(8.0),
        child: MhFormatedText('''
## Sample save and apply ViewState
This sample shows how you can save the current ColumnLayout and how to apply a saved layout

### Things of interest:
- First reorder and resize some columns
- Tap or click on "Save current state"
- Again, reorder and resize some columns
- Tap or clock in "Apply saved state"
- You can alos use the "Apply state 1/2" buttons to apply some previously definied layouts
...
class _SampleSaveViewStateState extends State<SampleSaveViewState> {
  String _viewState = "";
  final String _viewState1 = '[{"id":"index","columnWidth":69.19999999999993},{"id":"pos","columnWidth":64.80000000000005},{"id":"text","columnWidth":406.0000000000022},{"id":"date","columnWidth":100.0}]';
  final String _viewState2 = '[{"id":"index","columnWidth":92.39999999999985},{"id":"date","columnWidth":93.60000000000002},{"id":"text","columnWidth":406.0000000000022},{"id":"pos","columnWidth":189.60000000000068}]';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          TextButton(onPressed: () => _viewState = mhItemsView.getColumnLayoutJson(), child: const Text("Save current state")),
          TextButton(
              onPressed: () {
                if (_viewState == "") {
                  showDialog<String>(
          ...
          TextButton(onPressed: () => mhItemsView.setColumnLayoutFromJson(jsonStr: _viewState1), child: const Text("Apply state 1")),
          TextButton(onPressed: () => mhItemsView.setColumnLayoutFromJson(jsonStr: _viewState2), child: const Text("Apply state 2")),
        ],
      ),
    );
  }
