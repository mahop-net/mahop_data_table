...
class _SampleSelectionModesState extends State<SampleSelectionModes> {
  ...
  void initState() {
    ...
    settings.selectionSettings.selectionType =
  ...
  Widget buildSampleToolBar() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Padding(
              padding: EdgeInsets.all(16.0), child: Text("Selection Mode:")),
          SegmentedButton<MhItemsViewSelectionModes>(
            showSelectedIcon: false,
            segments: const <ButtonSegment<MhItemsViewSelectionModes>>[
              ButtonSegment<MhItemsViewSelectionModes>(
                  value: MhItemsViewSelectionModes.none, label: Text('None')),
              ButtonSegment<MhItemsViewSelectionModes>(
                  value: MhItemsViewSelectionModes.single,
                  label: Text('Single')),
              ButtonSegment<MhItemsViewSelectionModes>(
                  value: MhItemsViewSelectionModes.multiple,
                  label: Text('Multiple')),
            ],
            selected: <MhItemsViewSelectionModes>{
              settings.selectionSettings.selectionMode
            },
          ...
          const Padding(
              padding: EdgeInsets.all(16.0), child: Text("Selection Type:")),
          SegmentedButton<MhItemsViewSelectionTypes>(
            showSelectedIcon: false,
            segments: const <ButtonSegment<MhItemsViewSelectionTypes>>[
              ButtonSegment<MhItemsViewSelectionTypes>(
                  value: MhItemsViewSelectionTypes.fullRow,
                  label: Text('Full Row')),
              ButtonSegment<MhItemsViewSelectionTypes>(
                  value: MhItemsViewSelectionTypes.selectionColumnOnly,
                  label: Text('Selection column')),
            ],
            selected: <MhItemsViewSelectionTypes>{
              settings.selectionSettings.selectionType
            },
